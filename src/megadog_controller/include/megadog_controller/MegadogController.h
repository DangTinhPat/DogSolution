...
private:
    ...
    // world instead of always rendering pinned at the origin (Fixed Frame
    // "base" - the previous default - makes the base itself the coordinate
    // origin, so only the legs' motion relative to it is ever visible).
